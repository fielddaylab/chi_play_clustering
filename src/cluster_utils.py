...
class options:
    options = namedtuple('Options', ['game','name','filter_args','new_feat_args','lvlfeats','lvlrange','finalfeats','zthresh','finalfeats_readable'])
	...
	[],
	range(0, 1),
	['bloom_achs_per_sess_second', 'farm_achs_per_sess_second', 'money_achs_per_sess_second', 'pop_achs_per_sess_second', 'sessDuration'],
	3,
	...
	{'one_query': False, 'cont': False, 'max_sessDuration': None, 'min_sessDuration': 300, 'min_lvlend_ActiveEventCount': 3, 'min_lvlstart_ActiveEventCount': 3, 'min_sessActiveEventCount': 10, 'no_debug': True, 'lvlend': None, 'lvlstart': None, 'only_query_list': False, 'query_list': [], 'fillna': 0, 'verbose': False},
	{'avg_tile_hover_lvl_range': None, 'verbose': False},
	['count_blooms', 'count_deaths', 'count_farmfails', 'count_food_produced', 'count_milk_produced'],
	range(0, 2),
	['avg_lvl_0_to_1_count_deaths', 'avg_lvl_0_to_1_count_farmfails', 'avg_lvl_0_to_1_count_food_produced', 'avg_lvl_0_to_1_count_milk_produced'], #'avg_lvl_0_to_1_count_blooms', ,
	3,
...
def filter_df(df, fillna = 0, query_list=None, only_query_list=False, lvlstart=None, lvlend=None, no_debug=True, min_sessActiveEventCount=10,
...
def describe_lvl_feats(df, fbase_list, lvl_range, level_time=300,level_overlap=30):
    ...
    df = df.query(query)
    metadata.append(f'Describe Level Feats lvls {lvl_start} to {lvl_end}. Assuming WINDOW_SIZE_SECONDS={level_time} and WINDOW_OVERLAP_SECONDS={level_overlap}, filtered by ({query})')
...
def multi_checkbox_widget(descriptions, category):
    ...
    options_dict = {description: widgets.Checkbox(description=description, value=False, layout={'overflow-x': 'scroll','width':'400px'}, indent=False) for description in descriptions}
